...
- (void)viewDidLoad {
    [super viewDidLoad];
	imageOperation = [[NSMutableArray alloc] init];
    ...
    [imageOperation addObject:@"EdgeDetection"];
    [imageOperation addObject:@"AutoLocalThreshold"];
    [imageOperation addObject:@"AutoThreshold"];
    [imageOperation addObject:@"GaussianBlur"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Set up the cell...
	cell.text=[imageOperation objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[resultViewController setImage:[UIImage imageWithContentsOfFile:[imagesPath stringByAppendingPathComponent:@"elmo.jpg"]] withOperation:[imageOperation objectAtIndex:indexPath.row]]; //[bundleFiles objectAtIndex:indexPath.row]]]];
